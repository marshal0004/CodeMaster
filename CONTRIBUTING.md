...
Thank you for your interest in codeMaster! We appreciate your enthusiasm and support.

## Current Status

**codeMaster is in active development** — our team is iterating quickly and making lots of changes under the hood. Because of this pace, we may be slower than usual when reviewing PRs and issues.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/marshal0004/CodeMaster.git
   cd CodeMaster
   ```
...
Logs are written to `~/.codemaster/logs/codemaster.log` by default. Control logging via environment variables:
...
```bash
LOG_LEVEL=DEBUG uv run codemaster
```
...
If you have questions about using codeMaster, please check the [README](README.md) first. For other inquiries, feel free to open a discussion or issue.

Thank you for helping make codeMaster better!
